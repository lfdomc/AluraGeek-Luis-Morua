...
async function recibirDatosAPI() {
    try {
        ...
        const url = "https://repositorio-json-falso.vercel.app/Items";
...
async function crearNuevoItem(name, price, image) {
    ...
    const url2 = "https://repositorio-json-falso.vercel.app/Items";
    try {
...
export async function eliminarItem(id) {
    ...
    const url = `https://repositorio-json-falso.vercel.app/Items/${id}`;
    try {
